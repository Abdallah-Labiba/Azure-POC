# Azure Deployment Script for POC API
param(
...
Write-Host "Starting Azure deployment for POC API..." -ForegroundColor Green
...
try {
    $response = Invoke-RestMethod -Uri "$appServiceUrl/healthz" -Method Get
